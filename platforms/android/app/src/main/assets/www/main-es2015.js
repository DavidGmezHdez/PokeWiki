...
const routes = [
    ...
    {
        path: 'pokemons',
        loadChildren: () => Promise.all(/*! import() | pages-pokemons-pokemons-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-pokemons-pokemons-module")]).then(__webpack_require__.bind(null, /*! ./pages/pokemons/pokemons.module */ "./src/app/pages/pokemons/pokemons.module.ts")).then(m => m.PokemonsPageModule)
    },
    {
        path: 'pokemons/:id',
        loadChildren: () => Promise.all(/*! import() | pages-pokemon-pokemon-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-pokemon-pokemon-module")]).then(__webpack_require__.bind(null, /*! ./pages/pokemon/pokemon.module */ "./src/app/pages/pokemon/pokemon.module.ts")).then(m => m.PokemonPageModule)
    },
];
...
/* harmony import */ var _ionic_native_sqlite_porter_ngx__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @ionic-native/sqlite-porter/ngx */ "./node_modules/@ionic-native/sqlite-porter/__ivy_ngcc__/ngx/index.js");
...
module.exports = __webpack_require__(/*! /mnt/d/Github/ionic/pokemonWiki/src/main.ts */"./src/main.ts");
